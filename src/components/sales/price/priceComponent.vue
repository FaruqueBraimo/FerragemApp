      ...
      <template v-slot:append>
		...
		<div class="" style="">
			...
			<q-card square class="">
				<q-tabs
					...
					narrow-indicator
				>
					<q-tab name="mails" label="Detalhes da Cotação" />
				...
				<q-tab-panels v-model="tab" animated>
					<q-tab-panel name="mails">
						<q-card
							class="my-card bg-blue-grey-1"
							flat
							bordered
							square
						>
                        	
							<div class="row q-pa-sm text-blue-grey-10 ">
		...
		<div class="q-pt-xl col-12">
				<q-btn
					...
					label="Finalizar"
					:disable="disable"
					@click="$emit('price',{  subtotal : getSubTotal, iva:0, client :client , deadline : date})"
